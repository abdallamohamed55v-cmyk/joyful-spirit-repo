...
export const AGENTS: AgentDef[] = [
  ...
  { id: "operator", label: "Megsy OS", mention: "@megsy-os", icon: MegsyComputerIcon as unknown as LucideIcon, color: "text-foreground", bg: "bg-foreground/10", description: "A full cloud computer: plans, researches, codes, and ships apps (Pro+)", category: "chat" },
