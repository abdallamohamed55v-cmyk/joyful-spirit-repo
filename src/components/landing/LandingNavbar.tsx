            ...
            isDropdown(item) ? (
              ...
              >
                <button
                  ...
                  className="flex items-center gap-1 rounded-lg px-3.5 py-2 text-sm font-medium text-white transition-colors hover:text-white">
                  {item.label}
                                ...
                                <div className="space-y-5">
                                  {col.items.map((sub) => (
                                    ...
                                    >
                                      ...
                                      <span className="text-[13px] text-white group-hover:text-white transition-colors mt-1">
                                        {sub.desc}
                                      </span>
                                    </button>
                                  ))}
              ...
              <a
                ...
                className="rounded-lg px-3.5 py-2 text-sm font-medium text-white transition-colors hover:text-white"
              >
                {item.label}
              </a>
            )
