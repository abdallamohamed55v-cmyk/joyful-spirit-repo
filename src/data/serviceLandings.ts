...
const TOP_IMAGE_MODELS: LandingModel[] = [
  { name: "Nano Banana Pro", tag: "Google · 2K/4K", desc: "Google's flagship image model — sharp text, native 2K & 4K, unmatched detail." },
  { name: "Seedream 4.0", tag: "ByteDance · 4K", desc: "Cinematic photoreal at 4K with multi-reference fusion and perfect typography." },
  { name: "FLUX 1.1 Pro Ultra", tag: "Black Forest Labs", desc: "Up to 4MP raw photorealism with industry-leading prompt adherence." },
  { name: "Ideogram v3", tag: "Best-in-class text", desc: "The undisputed king of in-image text, logos, and poster typography." },
  { name: "GPT Image 1", tag: "OpenAI", desc: "OpenAI's multimodal generator — knowledge-grounded scenes and edits." },
  { name: "Recraft V3", tag: "Vector + raster", desc: "Designer-grade vector, brand styles, and structured layouts." },
  { name: "Imagen 4 Ultra", tag: "Google DeepMind", desc: "Photorealism with deep world knowledge from Google DeepMind." },
  { name: "Midjourney v7 style", tag: "Aesthetic", desc: "Stylized, art-directed looks that feel hand-crafted." },
];

const TOP_VIDEO_MODELS: LandingModel[] = [
  { name: "Veo 3.1", tag: "Google · audio", desc: "Cinematic 1080p with native synced audio and physical realism." },
  { name: "Sora 2 Pro", tag: "OpenAI", desc: "Long, story-driven shots with strong character & scene continuity." },
  { name: "Kling 2.5 Master", tag: "Kuaishou", desc: "Lifelike motion and natural physics for product and human shots." },
  { name: "Runway Gen-4", tag: "Runway", desc: "Production-quality video for filmmakers and brand teams." },
  { name: "Hailuo 02", tag: "MiniMax", desc: "Fast, expressive characters with great lip-sync." },
  { name: "Wan 2.5", tag: "Alibaba", desc: "Crisp, controllable video with strong text-in-scene fidelity." },
];

const CODE_MODELS: LandingModel[] = [
  { name: "Claude Sonnet 4.5", tag: "Anthropic", desc: "Best-in-class coding agent — long context, refactors, and architecture." },
  { name: "GPT-5.1 Codex", tag: "OpenAI", desc: "Reasoning-first coder for complex multi-file changes." },
  { name: "Gemini 3 Pro", tag: "Google", desc: "1M-token context for whole-repo understanding." },
  { name: "DeepSeek V3.2", tag: "Open weights", desc: "Fast, cheap, and excellent at tool-use and code." },
];

const AGENT_MODELS: LandingModel[] = [
  { name: "Operator", tag: "Browser agent", desc: "Drives a real browser — books, buys, fills forms, scrapes pages." },
  { name: "Deep Research", tag: "Multi-step", desc: "Reads dozens of sources and writes a fully cited brief." },
  { name: "Code Agent", tag: "Builds apps", desc: "Plans, codes, runs, and deploys full applications." },
  { name: "Slides Agent", tag: "Decks in minutes", desc: "Turns a prompt into a polished, on-brand presentation." },
];
...
export const SERVICE_LANDINGS: ServiceLanding[] = [
  // ═══════════════════ CODE — multilingual + variants ═══════════════════
  {
    ...
    description: "Describe what you want and Megsy ships a production-ready app. No setup, no boilerplate, no DevOps. Powered by Claude Sonnet 4.5, GPT-5.1 Codex and Gemini 3 Pro.",
    keywords: "build ai app, ai website builder, ai code generator, no-code ai, full stack ai builder",
    eyebrow: "AI Coding",
    heading: "What will you",
    headingAccent: "build",
    subhead: "Turn a single sentence into a deployed app. Frontend, backend, database, auth, payments — wired up and live.",
    ...
    features: [
      { title: "Full-stack in one prompt", body: "React, Tailwind, Postgres, auth, file storage, edge functions — all generated and connected." },
      { title: "Real preview, real DB", body: "Every project gets a live URL, an isolated database, and one-click custom domain publishing." },
      { title: "Edit by chatting", body: "Talk to your codebase. Megsy reads the repo, plans the change, and ships a working diff." },
      { title: "Bring your stack", body: "Connect Supabase, Stripe, Resend, Cloudflare R2, and 30+ integrations in two clicks." },
    ],
    models: CODE_MODELS,
    highlights: ["Live preview URL", "Custom domain publishing", "GitHub export", "Edge functions included"],
    faqs: [
      { q: "Do I need to know how to code?", a: "No. Describe what you want in plain English (or any language) and Megsy writes, runs, and deploys it for you." },
      { q: "Can I export the code?", a: "Yes. Every project can be pushed to GitHub at any time — you own 100% of the code." },
      { q: "Which AI models power the coder?", a: "Claude Sonnet 4.5, GPT-5.1 Codex, Gemini 3 Pro and DeepSeek V3.2 — automatically routed for the task." },
    ],
  ...
  },
  {
    ...
    description: "Generate a complete, responsive website from a one-line prompt. Custom design, real CMS, custom domain, blazing-fast hosting.",
    keywords: "ai website builder, ai web design, generate website with ai, ai landing page builder",
    eyebrow: "Websites",
    heading: "Launch your",
    headingAccent: "website",
    subhead: "Marketing pages, portfolios, agency sites, and e-commerce — designed, coded, and published by AI.",
    placeholder: "Ask Megsy to build a portfolio site...",
    primaryCta: { label: "Start your site free", href: "/code" },
    features: [
      { title: "On-brand by default", body: "Pick a vibe — Megsy chooses fonts, colors, and motion. Or upload your brand kit." },
      { title: "Real CMS, no plugins", body: "Blog, projects, products — every section is editable with a Postgres backing store." },
      { title: "SEO that ranks", body: "Per-page meta, sitemap, JSON-LD, og:images, and lighthouse-perfect performance out of the box." },
      { title: "Custom domain in 1 click", body: "Bring your domain or buy one inside Megsy — HTTPS and global CDN included." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "Will the site be fast?", a: "Yes — every site is statically rendered on a global CDN and scores 95+ on Lighthouse." },
      { q: "Can it handle e-commerce?", a: "Yes. Stripe, Paddle, and Shopify are first-class integrations." },
    ],
  },
  {
    ...
    description: "Auth, billing, dashboard, database, emails — generated and wired up. Take your SaaS from idea to paying customer faster than ever.",
    keywords: "saas mvp generator, ai startup builder, ai mvp, build saas with ai",
    eyebrow: "SaaS MVPs",
    heading: "Ship your",
    headingAccent: "SaaS",
    subhead: "Stripe billing, magic-link auth, team workspaces, transactional emails — all generated for your idea.",
    placeholder: "Ask Megsy to build an analytics SaaS...",
    primaryCta: { label: "Generate my MVP", href: "/code" },
    features: [
      { title: "Auth & billing day one", body: "Email, Google, GitHub auth + Stripe subscriptions and metered billing — preconfigured." },
      { title: "Multi-tenant ready", body: "Workspaces, roles, invites, and row-level security baked in." },
      { title: "Transactional emails", body: "Resend integration with branded templates and webhook tracking." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "Is the code production-ready?", a: "Yes — typed, tested, and deployable. You can iterate forever inside Megsy or export to GitHub." },
    ],
  },
  ...
  // ── Code — Arabic variants ──
  {
    ...
    description: "اكتب فكرتك بجملة واحدة وميجسي تبني التطبيق كامل: واجهة، قاعدة بيانات، تسجيل دخول، ودفع. بدون إعدادات أو خوادم.",
    keywords: "بناء تطبيق بالذكاء الاصطناعي, موقع AI, مولد كود ذكي, تطبيق بدون برمجة",
    eyebrow: "البرمجة بالذكاء الاصطناعي",
    heading: "ماذا ستـ",
    headingAccent: "بني؟",
    subhead: "من فكرة إلى تطبيق منشور على الإنترنت بجملة واحدة. واجهة، قاعدة بيانات، تسجيل دخول، ومدفوعات — جاهزة فوراً.",
    ...
    features: [
      { title: "تطبيق كامل بأمر واحد", body: "React، Tailwind، Postgres، تسجيل دخول، تخزين ملفات — كله متصل وجاهز." },
      { title: "معاينة حقيقية وقاعدة بيانات", body: "كل مشروع يحصل على رابط مباشر وقاعدة بيانات منفصلة ونشر بنطاق مخصص بضغطة." },
    ...
    faqs: [
      ...
      { q: "ما هي النماذج المستخدمة؟", a: "Claude Sonnet 4.5 وGPT-5.1 Codex وGemini 3 Pro وDeepSeek V3.2 — يختار النموذج الأمثل تلقائياً." },
    ],
  ...
  },
  {
    ...
    description: "أنشئ موقعاً متجاوباً كاملاً من سطر واحد. تصميم مخصص، لوحة تحكم محتوى، نطاق مخصص، واستضافة فائقة السرعة.",
    keywords: "بناء موقع بالذكاء الاصطناعي, مولد موقع ويب, تصميم موقع AI",
    eyebrow: "المواقع",
    heading: "أطلق",
    headingAccent: "موقعك",
    subhead: "صفحات تسويقية، معارض أعمال، مواقع وكالات، ومتاجر إلكترونية — كل ذلك بتصميم ذكي ونشر تلقائي.",
    placeholder: "اطلب من ميجسي موقع لمعرض أعمالي...",
    primaryCta: { label: "ابدأ موقعك مجاناً", href: "/code" },
    features: [
      { title: "هوية بصرية فورية", body: "اختر الطابع — ميجسي تختار الخطوط والألوان والحركة. أو ارفع دليل هويتك." },
      { title: "نظام محتوى حقيقي", body: "مدونة، مشاريع، منتجات — كل قسم قابل للتعديل بقاعدة بيانات حقيقية." },
      { title: "SEO يتصدر جوجل", body: "بيانات وصفية لكل صفحة وخريطة موقع وأداء ممتاز افتراضياً." },
      { title: "نطاق مخصص بضغطة", body: "اربط نطاقك أو اشتر واحداً داخل ميجسي — HTTPS وشبكة CDN عالمية." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "هل الموقع سريع؟", a: "نعم — يُقدَّم من شبكة CDN عالمية ويسجل أكثر من 95 في Lighthouse." },
    ],
  },
  ...
  // ── Code — Spanish ──
  {
    ...
    description: "Describe tu idea y Megsy construye una app lista para producción. Sin configuración, sin DevOps, sin código repetitivo.",
    ...
    subhead: "Convierte una frase en una app desplegada. Frontend, backend, base de datos y pagos — todo conectado.",
    placeholder: "Pide a Megsy un panel SaaS...",
    primaryCta: { label: "Empieza gratis", href: "/code" },
    features: [
      { title: "Stack completo en un prompt", body: "React, Tailwind, Postgres, auth y funciones edge — generado y conectado." },
      { title: "Vista previa real, BD real", body: "Cada proyecto tiene URL en vivo, base de datos aislada y dominio personalizado." },
      { title: "Edita conversando", body: "Habla con tu código. Megsy lee el repo, planifica y entrega un diff que funciona." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "¿Necesito saber programar?", a: "No. Describe tu idea y Megsy escribe y despliega el código por ti." },
    ],
  },
  ...
  // ── Code — French ──
  {
    ...
    description: "Décrivez votre idée — Megsy livre une application prête pour la production. Sans configuration, sans DevOps.",
    keywords: "créer application avec ia, générateur site web ia, coder avec intelligence artificielle",
    eyebrow: "Programmation IA",
    heading: "Que voulez-vous",
    headingAccent: "construire ?",
    subhead: "Transformez une phrase en application déployée. Frontend, backend, base de données — tout connecté.",
    placeholder: "Demandez à Megsy un dashboard SaaS...",
    primaryCta: { label: "Commencez gratuitement", href: "/code" },
    features: [
      { title: "Stack complète", body: "React, Tailwind, Postgres et fonctions edge — générés et reliés." },
      { title: "Aperçu et BD réels", body: "Chaque projet obtient une URL live, une base isolée et un domaine personnalisé." },
      { title: "Éditer en discutant", body: "Parlez à votre code. Megsy lit le repo et livre un diff fonctionnel." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "Dois-je savoir coder ?", a: "Non. Décrivez votre idée et Megsy écrit et déploie le code pour vous." },
    ],
  },
  ...
  // ── Code — German ──
  {
    ...
    description: "Beschreibe deine Idee und Megsy liefert eine produktionsreife App. Ohne Setup, ohne Boilerplate, ohne DevOps.",
    keywords: "ki app bauen, website mit ki erstellen, ki code generator",
    eyebrow: "KI-Programmierung",
    heading: "Was willst du",
    headingAccent: "bauen?",
    subhead: "Aus einem Satz eine deployte App. Frontend, Backend, Datenbank und Zahlung — alles verdrahtet.",
    placeholder: "Bitte Megsy, ein SaaS-Dashboard zu bauen...",
    primaryCta: { label: "Kostenlos starten", href: "/code" },
    features: [
      { title: "Full-Stack auf einmal", body: "React, Tailwind, Postgres, Auth, Edge Functions — generiert und verbunden." },
      { title: "Echte Preview, echte DB", body: "Jedes Projekt erhält eine Live-URL, isolierte DB und Custom Domain." },
      { title: "Per Chat bearbeiten", body: "Sprich mit deinem Code. Megsy liest das Repo und liefert einen funktionierenden Diff." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "Brauche ich Programmierkenntnisse?", a: "Nein. Beschreibe deine Idee und Megsy baut sie." },
    ],
  },
  ...
  // ── Code — Portuguese ──
  {
    ...
    description: "Descreva sua ideia e a Megsy entrega um app pronto para produção. Sem setup, sem DevOps, sem código repetitivo.",
    ...
    features: [
      { title: "Stack completa", body: "React, Tailwind, Postgres e edge functions — gerados e conectados." },
      { title: "Preview e DB reais", body: "Cada projeto recebe URL ao vivo, banco isolado e domínio próprio." },
      { title: "Edite conversando", body: "Fale com seu código. A Megsy lê o repo e entrega um diff funcional." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "Preciso saber programar?", a: "Não. Descreva sua ideia e a Megsy escreve e publica para você." },
    ],
  },
  ...
  // ═══════════════════ AGENTS ═══════════════════
  {
    ...
    description: "Deploy AI agents that drive browsers, research the web, write code, and produce decks — all from one prompt.",
    keywords: "ai agents, autonomous ai, ai browser agent, ai research agent, agent platform",
    eyebrow: "AI Agents",
    heading: "Hire an AI",
    headingAccent: "agent",
    subhead: "Operator drives a browser. Deep Research reads the internet. Code Agent ships apps. Slides Agent designs decks. One subscription, every agent.",
    placeholder: "Ask an agent to research the EV market...",
    primaryCta: { label: "Try agents free", href: "/" },
    secondaryCta: { label: "See pricing", href: "/pricing" },
    features: [
      { title: "Operator — your browser, automated", body: "Books flights, fills forms, scrapes dashboards, clicks through real sites." },
      { title: "Deep Research", body: "Reads 50+ sources, cross-checks facts, writes a cited brief in minutes." },
      { title: "Code Agent", body: "Plans the feature, edits files, runs the dev server, and ships a working diff." },
      { title: "Slides Agent", body: "Turns a topic into a polished, on-brand presentation with images and speaker notes." },
    ],
    models: AGENT_MODELS,
    faqs: [
      { q: "Are the agents safe?", a: "Yes — every agent runs in a sandboxed environment and asks for confirmation on sensitive actions." },
      { q: "Can they use my tools?", a: "Yes — connect Gmail, GitHub, Slack, Notion, Supabase and 30+ apps." },
    ],
  },
  {
    ...
    description: "An AI that drives a real Chrome browser. Web scraping, form filling, ticket booking, dashboard QA — done autonomously.",
    keywords: "ai browser automation, ai operator, web scraping ai, autonomous browser agent",
    eyebrow: "Operator",
    heading: "Let AI",
    headingAccent: "click for you",
    subhead: "Real Chrome browser, real cookies, real logins. Operator gets the job done — and shows you a recording.",
    placeholder: "Ask Operator to book a flight to Tokyo...",
    primaryCta: { label: "Launch Operator", href: "/" },
    features: [
      { title: "Real browser, real cookies", body: "Logs into your accounts (with your permission) and performs tasks end-to-end." },
      { title: "Replay everything", body: "Watch a recording of every click, scroll, and form fill." },
      { title: "Multi-step planning", body: "Decomposes goals like 'compare 10 vendors' into a sequence of browser actions." },
    ],
    models: AGENT_MODELS.slice(0, 3),
    faqs: [
      { q: "How is this different from scraping?", a: "Operator handles JavaScript-heavy sites, logins, captchas, and adapts when layouts change." },
    ],
  },
  {
    slug: "ar/ai-agents",
    ...
    description: "وكلاء يديرون المتصفح، يبحثون في الإنترنت، يكتبون الكود، ويصممون العروض — كل ذلك من رسالة واحدة.",
    keywords: "وكلاء ذكاء اصطناعي, AI agents بالعربي, وكيل متصفح",
    eyebrow: "وكلاء AI",
    heading: "وظف وكيل",
    headingAccent: "ذكاء اصطناعي",
    subhead: "Operator يتحكم بالمتصفح، Deep Research يقرأ الإنترنت، Code Agent يبني التطبيقات، Slides Agent يصمم العروض.",
    placeholder: "اطلب من Deep Research دراسة سوق السيارات الكهربائية...",
    primaryCta: { label: "جرب الوكلاء مجاناً", href: "/" },
    features: [
      { title: "Operator — متصفحك آلياً", body: "يحجز رحلات، يملأ نماذج، ويتنقل في المواقع الحقيقية." },
      { title: "Deep Research", body: "يقرأ عشرات المصادر ويكتب تقريراً موثقاً خلال دقائق." },
      { title: "Code Agent", body: "يخطط الميزة، يعدل الملفات، يشغّل الخادم، ويسلّم تغييراً جاهزاً." },
      { title: "Slides Agent", body: "يحوّل موضوعاً إلى عرض احترافي بالصور والملاحظات." },
    ],
    models: AGENT_MODELS,
    faqs: [
      { q: "هل الوكلاء آمنون؟", a: "نعم — كل وكيل يعمل في بيئة معزولة ويطلب التأكيد قبل العمليات الحساسة." },
    ],
  },
  ...
  // ═══════════════════ DEEP RESEARCH ═══════════════════
  {
    ...
    description: "Megsy Deep Research reads 50+ sources, cross-checks every claim, and writes a McKinsey-grade report with citations.",
    ...
    features: [
      { title: "Reads 50+ sources", body: "News, PDFs, papers, filings, transcripts. Anything Google can reach." },
      { title: "Every claim is cited", body: "Inline footnotes link back to the original sentence on the original page." },
      { title: "Re-runnable", body: "Save a research, refresh it weekly, get a diff of what changed." },
    ],
    faqs: [
      { q: "How accurate is it?", a: "Every claim comes with a source. You can click any footnote to verify in seconds." },
    ],
  },
  {
    ...
    description: "ميجسي تقرأ أكثر من 50 مصدراً، تتحقق من كل ادعاء، وتكتب تقريراً احترافياً بمراجع كاملة خلال دقائق.",
    ...
    faqs: [
      { q: "ما مدى الدقة؟", a: "كل معلومة لها مصدر يمكن النقر عليه للتحقق." },
    ],
  },
  {
    ...
    description: "Lee más de 50 fuentes, verifica cada dato y entrega un informe con citas en minutos.",
    ...
    subhead: "Mercados, competidores, papers y especificaciones técnicas — informes citados en 5–15 minutos.",
    ...
    faqs: [
      { q: "¿Es fiable?", a: "Sí — cada afirmación tiene una fuente verificable." },
    ],
  },
  ...
  // ═══════════════════ SLIDES ═══════════════════
  {
    ...
    description: "Type a topic, get a polished, on-brand presentation with images, charts, and speaker notes. Export to PPTX, PDF, or Google Slides.",
    ...
    subhead: "Pitches, lectures, reports, sales decks — designed by AI, editable like Keynote, export anywhere.",
    placeholder: "Make a 10-slide pitch deck for a fintech startup...",
    primaryCta: { label: "Make a deck", href: "/" },
    features: [
      { title: "On-brand by default", body: "Upload a logo, pick a vibe — every slide matches your identity." },
      { title: "Real charts, real images", body: "Live charts from your data, AI-generated visuals, royalty-free stock." },
      { title: "Export anywhere", body: "PPTX, PDF, Google Slides, or share a live link." },
    ],
    faqs: [
      { q: "Can I edit a slide manually?", a: "Yes — every block is editable like a real slide tool." },
    ],
  },
  {
    slug: "ar/ai-slides",
    ...
    description: "اكتب الموضوع واحصل على عرض احترافي بصور ومخططات وملاحظات للمتحدث. صدّر إلى PPTX أو PDF أو Google Slides.",
    ...
    faqs: [
      { q: "هل يمكنني تعديل شريحة يدوياً؟", a: "نعم — كل عنصر قابل للتعديل بحرية." },
    ],
  },
  {
    ...
    description: "Escribe un tema y obtén una presentación pulida con imágenes, gráficos y notas para el orador.",
    ...
    features: [
      { title: "Identidad de marca", body: "Sube tu logo y elige un estilo — todas las slides combinan." },
      { title: "Gráficos reales", body: "Gráficos en vivo desde tus datos y visuales generados por IA." },
      { title: "Exporta a todo", body: "PPTX, PDF, Google Slides o enlace en vivo." },
    ],
    faqs: [
      { q: "¿Puedo editar manualmente?", a: "Sí — cada bloque se edita como en una herramienta clásica." },
    ],
  },
  ...
  // ═══════════════════ MEDIA ═══════════════════
  {
    ...
    description: "Generate unlimited 2K & 4K images with every top model — Nano Banana Pro, Seedream 4, FLUX 1.1 Pro Ultra, Ideogram v3 and more. One subscription.",
    keywords: "unlimited ai image generator, nano banana pro, seedream 4, flux ultra, ai image generator unlimited",
    ...
    features: [
      { title: "Every top model", body: "Nano Banana Pro, Seedream 4, FLUX 1.1 Pro Ultra, Ideogram v3, GPT Image 1, Recraft V3, Imagen 4 Ultra." },
      { title: "Truly unlimited", body: "Plans don't meter per-image — generate all day, every day." },
    ...
    highlights: ["Unlimited generations", "2K & 4K native", "Commercial license", "All top models", "Free trial"],
    faqs: [
      { q: "Is it really unlimited?", a: "Yes. Paid plans have no per-image cap — generate as many as you want." },
  ...
  },
  {
    ...
    description: "أنشئ صوراً غير محدودة بدقة 2K و4K مع أفضل النماذج — Nano Banana Pro وSeedream 4 وFLUX 1.1 Pro Ultra وIdeogram v3 — باشتراك واحد.",
    ...
    features: [
      { title: "كل النماذج الكبرى", body: "Nano Banana Pro وSeedream 4 وFLUX 1.1 Pro Ultra وIdeogram v3 وGPT Image 1 وRecraft V3." },
  ...
  },
  {
    ...
    description: "Crea imágenes ilimitadas en 2K y 4K con los mejores modelos — Nano Banana Pro, Seedream 4, FLUX Ultra, Ideogram v3.",
    ...
    features: [
      { title: "Todos los modelos top", body: "Nano Banana Pro, Seedream 4, FLUX Ultra, Ideogram v3, GPT Image 1, Recraft V3." },
      { title: "Realmente ilimitado", body: "Genera todas las que quieras, sin límite por imagen." },
      { title: "2K y 4K nativos", body: "Calidad lista para imprimir." },
      { title: "Uso comercial", body: "Cada imagen es tuya para vender." },
    ],
    models: TOP_IMAGE_MODELS,
    faqs: [
      { q: "¿De verdad es ilimitado?", a: "Sí — sin tope por imagen en los planes de pago." },
    ],
  },
  {
    ...
    description: "Generate cinematic AI video with Veo 3.1, Sora 2 Pro, Kling 2.5 Master, Runway Gen-4 and more. Audio included.",
    ...
    features: [
      { title: "Every top model", body: "Veo 3.1, Sora 2 Pro, Kling 2.5 Master, Runway Gen-4, Hailuo 02, Wan 2.5." },
      { title: "Native audio", body: "Veo 3.1 generates synced audio with the video." },
      { title: "Lip-sync & talking heads", body: "Turn a photo + script into a realistic talking video." },
    ],
    models: TOP_VIDEO_MODELS,
    faqs: [
      { q: "What's the max length?", a: "Depends on the model — up to 60s per shot, stitchable into long videos." },
    ],
  },
  ...
  // ═══════════════════ PER-MODEL IMAGE PAGES ═══════════════════
  {
    ...
    description: "Generate unlimited 2K & 4K images with Google's Nano Banana Pro (Gemini Image). Sharp text, photoreal detail, full commercial use.",
    ...
    subhead: "Native 2K & 4K, the sharpest text rendering on the market, and physical realism that fools the eye.",
    ...
    features: [
      { title: "Best text rendering", body: "Posters, logos, packaging — typography looks designed, not generated." },
    ...
    highlights: ["2K & 4K native", "Best-in-class text", "Unlimited generations", "Commercial license"],
    faqs: [
      { q: "Is this really Google's Nano Banana Pro?", a: "Yes — the same Gemini Image model, served on Megsy with unlimited quota." },
    ],
  },
  {
    ...
    description: "ByteDance Seedream 4 delivers cinematic 4K photorealism, multi-reference fusion, and perfect text. Unlimited on Megsy.",
    ...
    subhead: "Seedream 4 fuses up to 6 reference images and renders 4K scenes with film-grade composition.",
    placeholder: "An anamorphic film still of a lone figure in fog...",
    primaryCta: { label: "Try Seedream 4", href: "/images?model=seedream-4" },
    features: [
      { title: "Multi-reference fusion", body: "Combine up to 6 references to lock character, scene, and style." },
    ...
    models: TOP_IMAGE_MODELS,
    faqs: [
      { q: "Is Seedream good for product shots?", a: "Yes — it's one of the strongest models for clean, on-brand product imagery." },
    ],
  },
  {
    ...
    description: "Black Forest Labs' FLUX 1.1 Pro Ultra — raw 4MP photoreal output with industry-leading prompt adherence.",
    ...
    subhead: "FLUX Ultra renders raw photoreal images at up to 4MP with the best prompt adherence in the open ecosystem.",
    ...
    features: [
      { title: "Raw photorealism", body: "Skin, fabric, light — indistinguishable from a real camera in most cases." },
    ...
    models: TOP_IMAGE_MODELS,
    faqs: [
      { q: "Is FLUX safe for commercial use?", a: "Yes — every image you generate on Megsy carries a commercial license." },
    ],
  },
  {
    ...
    description: "The undisputed king of in-image text, logos, and poster typography. Unlimited generations on Megsy.",
    keywords: "ideogram v3, ai text in image, ai poster generator, logo ai",
    eyebrow: "Ideogram v3",
    heading: "Typography that",
    headingAccent: "actually reads",
    subhead: "Ideogram v3 is the model designers reach for when text has to be perfect — logos, posters, packaging, ads.",
    ...
    features: [
      ...
      { title: "Designer styles", body: "Editorial, vintage, swiss, brutalist — applied consistently." },
      { title: "Unlimited", body: "Iterate as much as you need on paid plans." },
    ],
    faqs: [
      { q: "Is Ideogram good for logos?", a: "It's one of the strongest models for clean logo concepts." },
    ],
  },
  {
    ...
    description: "OpenAI's GPT Image 1 with full knowledge grounding, controllable edits, and unlimited generations on Megsy.",
    keywords: "gpt image 1, openai image generator, gpt-4o image, gpt image unlimited",
    eyebrow: "GPT Image 1",
    heading: "OpenAI's",
    headingAccent: "image brain",
    subhead: "GPT Image 1 understands the world — references, history, brands, science — and renders accurate, controllable images.",
    ...
    features: [
      { title: "World knowledge", body: "Accurate references to real places, people, and concepts." },
      { title: "Controllable edits", body: "Inpaint, outpaint, and refine with natural-language instructions." },
  ...
  },
  {
    ...
    description: "Brand-grade vector and raster output, controllable styles, and unlimited generations on Megsy.",
    keywords: "recraft v3, ai vector generator, ai logo design, brand ai image",
    eyebrow: "Recraft V3",
    heading: "Vector-grade",
    headingAccent: "AI for design",
    subhead: "Recraft V3 outputs true vector SVGs, locked brand styles, and structured layouts ready for production.",
    ...
    features: [
      { title: "True vector output", body: "Editable SVGs — scale to any size without quality loss." },
    ...
    faqs: [
      { q: "Does it export SVG?", a: "Yes — Recraft's hero output format is vector SVG." },
    ],
  },
  {
    ...
    description: "Photorealism with deep world knowledge from Google DeepMind. Unlimited 2K generations on Megsy.",
    keywords: "imagen 4 ultra, google deepmind image, imagen unlimited",
    eyebrow: "Imagen 4 Ultra",
    heading: "DeepMind",
    headingAccent: "photorealism",
    subhead: "Imagen 4 Ultra combines Google DeepMind's world model with refined photoreal rendering.",
    ...
    features: [
      ...
      { title: "Photoreal rendering", body: "Skin, fabric, and lighting that look like a real camera." },
      { title: "Unlimited on Megsy", body: "No per-image fees." },
    ],
    faqs: [
      { q: "Is this Google's flagship?", a: "It's DeepMind's photoreal flagship, complementing Nano Banana Pro." },
    ],
  },
  {
    slug: "models/veo-3-1",
    ...
    description: "Generate cinematic 1080p video with native synced audio using Google's Veo 3.1. Available on Megsy.",
    keywords: "veo 3.1, google veo, ai video with audio, cinematic ai video",
    eyebrow: "Veo 3.1",
    heading: "Cinematic video,",
    headingAccent: "with audio",
    subhead: "Veo 3.1 is the first major model to generate synchronized audio with cinematic 1080p video.",
    placeholder: "A 5-second drone shot over the Amalfi coast at sunset...",
    primaryCta: { label: "Try Veo 3.1", href: "/videos?model=veo-3.1" },
    features: [
      { title: "Native audio", body: "Ambient sound, dialogue, and Foley generated with the video." },
      { title: "Cinematic 1080p", body: "Composition, lighting, and camera moves that feel directed." },
      { title: "Strong physics", body: "Believable motion, water, fabric, and crowds." },
    ],
    models: TOP_VIDEO_MODELS,
    faqs: [
      { q: "Is the audio really generated?", a: "Yes — Veo 3.1 generates synced audio natively, no overdub needed." },
    ],
  },
  {
    ...
    description: "OpenAI's Sora 2 Pro for long, story-driven AI video with strong character and scene continuity.",
    keywords: "sora 2 pro, openai sora, ai video long form, sora unlimited",
    eyebrow: "Sora 2 Pro",
    heading: "Story-driven",
    headingAccent: "AI video",
    subhead: "Sora 2 Pro keeps characters, lighting, and setting consistent across long, narrative shots.",
    ...
    features: [
      { title: "Long continuous shots", body: "Maintain identity and setting across complex scenes." },
    ...
    models: TOP_VIDEO_MODELS,
    faqs: [
      { q: "How long can a clip be?", a: "Sora 2 Pro supports significantly longer clips than first-gen video models." },
    ],
  },
  {
    ...
    description: "Kling 2.5 Master from Kuaishou — lifelike motion and natural physics for product shots, characters, and ads.",
    keywords: "kling 2.5, kling master, ai video kuaishou, ai motion video",
    eyebrow: "Kling 2.5 Master",
    heading: "Lifelike",
    headingAccent: "motion",
    subhead: "Kling 2.5 Master is the gold standard for realistic human and product motion in AI video.",
    ...
    features: [
      { title: "Realistic physics", body: "Cloth, water, hair — motion looks captured, not generated." },
    ...
    models: TOP_VIDEO_MODELS,
    faqs: [
      { q: "Is Kling good for product video?", a: "It's one of the strongest models for clean, photoreal product motion." },
    ],
  },
  ...
  // ═══════════════════ CHAT ═══════════════════
  {
    ...
    description: "Chat with Claude Sonnet 4.5, GPT-5.1, Gemini 3 Pro, and DeepSeek V3.2 — free, no login required, unlimited messages.",
    keywords: "free ai chat, chatgpt alternative, claude free, gemini free, ai chat no login",
    eyebrow: "AI Chat",
    heading: "Every AI,",
    headingAccent: "one chat",
    subhead: "Claude Sonnet 4.5, GPT-5.1, Gemini 3 Pro, DeepSeek V3.2 — switch between them mid-conversation. Free, no login.",
    placeholder: "Ask anything...",
    primaryCta: { label: "Start chatting", href: "/" },
    features: [
      { title: "Top frontier models", body: "Claude Sonnet 4.5, GPT-5.1, Gemini 3 Pro, DeepSeek V3.2 — pick the best for each task." },
      { title: "No login to try", body: "Open the page, start typing — that's it." },
      { title: "Modes for everything", body: "Learning, shopping, coding, image, video, research — built-in modes for every job." },
    ],
    faqs: [
      { q: "Is it really free?", a: "Yes — anonymous chat is free with generous limits. Paid plans unlock unlimited and premium models." },
    ],
  },
  ...
  // ═══════════════════ CHATGPT / MIDJOURNEY / LOVABLE ALTERNATIVE landings  ═══════════════════
  {
    ...
    description: "Get every frontier AI in one place — Claude Sonnet 4.5, Gemini 3 Pro, GPT-5.1, DeepSeek. Plus image, video, code, research.",
    ...
    subhead: "Why pay 5 subscriptions? Megsy bundles Claude, GPT-5.1, Gemini 3 Pro, image, video, code, slides, and research.",
    placeholder: "Ask Claude, GPT-5.1, and Gemini side by side...",
    primaryCta: { label: "Try Megsy free", href: "/" },
    features: [
      { title: "All frontier chats", body: "Claude Sonnet 4.5, GPT-5.1, Gemini 3 Pro, DeepSeek V3.2." },
      { title: "Beyond chat", body: "Image, video, slides, deep research, browser agent, full-stack coder — all included." },
      { title: "One bill", body: "One subscription replaces ChatGPT + Claude + Midjourney + Runway + Gamma." },
    ],
    faqs: [
      { q: "How does pricing compare?", a: "Megsy is typically 2–4x cheaper than the sum of individual subscriptions." },
    ],
  },
  {
    ...
    description: "Move beyond Midjourney with unlimited Nano Banana Pro, Seedream 4, FLUX Ultra, and Ideogram v3 — all in one app.",
    keywords: "midjourney alternative, best midjourney alternative, nano banana vs midjourney, flux vs midjourney",
    eyebrow: "Midjourney Alternative",
    heading: "Beyond",
    headingAccent: "Midjourney",
    subhead: "Get the newest models Midjourney doesn't have — Nano Banana Pro, Seedream 4, FLUX Ultra, Ideogram v3.",
    ...
    features: [
      ...
      { title: "Native 4K", body: "True 4K output from multiple models — Midjourney still tops out lower." },
      { title: "Perfect text", body: "Ideogram v3 and Nano Banana Pro nail typography Midjourney can't." },
    ],
    models: TOP_IMAGE_MODELS,
    faqs: [
      { q: "Is the quality really comparable?", a: "On most prompts, Nano Banana Pro and Seedream 4 outperform Midjourney v7." },
    ],
  },
  ...
  // ═══════════════════ SERVICES — extras ═══════════════════
  {
    ...
    description: "Inpaint, outpaint, remove backgrounds, swap faces, change clothes, relight scenes — every AI image edit in one app.",
    ...
    subhead: "Inpaint, outpaint, BG remove, relight, face swap, clothes change, upscale — all powered by SOTA models.",
  ...
  },
  {
    ...
    description: "Generate clean, brand-ready logos with Ideogram v3 and Recraft V3 — SVG export, color variants, unlimited iterations.",
    keywords: "ai logo generator, ai logo design, free logo ai, brand logo ai",
    eyebrow: "Logo Generator",
    heading: "Logos that",
    headingAccent: "look hired",
    subhead: "Ideogram v3 and Recraft V3 produce designer-grade logos with perfect text and clean vector output.",
    ...
    features: [
      ...
      { title: "Brand variants", body: "Color, mono, dark, and light variants generated together." },
      { title: "Unlimited iterations", body: "Keep refining until it's perfect." },
    ],
    faqs: [
      { q: "Do I own the logo?", a: "Yes — full commercial rights on every export." },
    ],
  },
  {
    ...
    description: "Studio-quality professional headshots from your selfies. LinkedIn-ready, every outfit, every background.",
    ...
    subhead: "Upload 10 selfies — get 100+ professional headshots with consistent identity across every shot.",
    ...
    faqs: [
      { q: "How many photos do I need?", a: "10–20 varied selfies give the best results." },
    ],
  },
  {
    ...
    description: "Generate high-CTR YouTube thumbnails with AI. Faces, bold text, brand colors — designed to win the click.",
    keywords: "ai thumbnail generator, youtube thumbnail ai, ai thumbnail maker, click through ai thumbnail",
    eyebrow: "Thumbnails",
    heading: "Thumbnails that",
    headingAccent: "earn the click",
    subhead: "Faces with reaction, bold text, brand colors — built using the patterns proven to lift CTR.",
    ...
    faqs: [
      { q: "Can I edit the text?", a: "Yes — text is editable after generation." },
    ],
  },
  ...
  // ═══════════════════ MORE — extra English variants per service ═══════════════════
  {
    ...
    description: "Your AI pair programmer. Reads your repo, plans changes, writes tests, opens PRs. Powered by Claude Sonnet 4.5, GPT-5.1 Codex and Gemini 3 Pro.",
    ...
    subhead: "Connect a GitHub repo and Megsy reads the whole codebase, plans the change, and opens a working PR.",
    placeholder: "Refactor the auth module to use JWT...",
    primaryCta: { label: "Connect a repo", href: "/code" },
    features: [
      { title: "Whole-repo context", body: "1M-token Gemini 3 Pro context for reading the entire codebase at once." },
      { title: "Writes tests too", body: "Every change ships with unit tests and passes CI before the PR opens." },
      { title: "Multi-file refactors", body: "Renames, extracts, migrations — handled across hundreds of files." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "How is this different from Copilot?", a: "Copilot autocompletes line by line. Megsy plans, edits multiple files, runs tests, and opens a PR." },
    ],
  },
  {
    ...
    description: "Build internal dashboards, admin panels, and CRUD tools from a one-line prompt. Connects to your Postgres, MySQL, or Supabase.",
    ...
    subhead: "Sales dashboards, ops consoles, customer-support panels — generated and connected to your real database.",
    placeholder: "A dashboard to manage refunds and customer issues...",
    primaryCta: { label: "Start building", href: "/code" },
    features: [
      { title: "Connect any database", body: "Postgres, MySQL, Supabase, MongoDB — auto-introspect schemas." },
      { title: "Role-based access", body: "Built-in auth and per-row permissions for sensitive ops data." },
      { title: "Charts, tables, forms", body: "Every primitive you need for real internal workflows." },
    ],
    models: CODE_MODELS,
    faqs: [
      { q: "Is this a Retool alternative?", a: "Yes — Megsy generates the same kind of internal apps, but from natural language." },
    ],
  },
  ...
  // ── More agent variants ──
  {
    ...
    description: "Your AI research analyst. Reads papers, filings, articles, and transcripts — writes a cited brief in minutes.",
    ...
    primaryCta: { label: "Start a research", href: "/" },
    features: [
      { title: "Multi-step planning", body: "Decomposes the topic into sub-questions and researches each one." },
    ...
    faqs: [{ q: "Can I trust the output?", a: "Every claim is cited — click any footnote to verify." }],
  },
  {
    ...
    description: "Point an AI agent at any site, get structured data out. JSON, CSV, Google Sheets — refresh on schedule.",
    keywords: "ai web scraping, ai data extraction, ai scraper, structured data ai",
    eyebrow: "Data Extraction",
    heading: "Any site,",
    headingAccent: "structured",
    subhead: "Tell Megsy what to extract — it logs in, paginates, handles changes, and ships clean JSON or CSV.",
    ...
    features: [
      ...
      { title: "Scheduled refresh", body: "Run hourly, daily, weekly — get diffs of what changed." },
      { title: "Export anywhere", body: "Sheets, Airtable, Postgres, webhook." },
    ],
    faqs: [{ q: "Does it bypass logins?", a: "No — Operator uses your credentials with your permission, never bypasses security." }],
  },
  ...
  // ── Image landings — more keyword angles ──
  {
    ...
    description: "Upload a product photo, get unlimited studio shots in every scene, lighting, and lifestyle context. Commercial license included.",
    ...
    headingAccent: "no studio",
    subhead: "Skincare on marble, sneakers in the desert, gadgets on white seamless — all generated, all yours.",
    ...
    features: [
      { title: "Preserves your product", body: "Pixel-accurate to your photo — colors, logos, textures intact." },
    ...
    models: TOP_IMAGE_MODELS,
    faqs: [{ q: "Is it good enough for Amazon listings?", a: "Yes — output is print and listing-ready." },
    ],
  },
  {
    ...
    description: "Turn 10 selfies into 100+ stylized AI avatars. Anime, oil paint, cyberpunk, corporate — every style.",
    ...
    faqs: [{ q: "Are my photos private?", a: "Yes — your training images are private to your account." }],
  },
  {
    ...
    description: "Generate AI images free with Nano Banana Pro, FLUX, Ideogram and more. No sign-up needed for the trial.",
    keywords: "free ai image generator, ai image generator free, no signup ai image",
    eyebrow: "Free Generator",
    heading: "Free AI",
    headingAccent: "images",
    subhead: "Try every top model free — no sign-up for your first generations. Unlimited on paid plans.",
    ...
    models: TOP_IMAGE_MODELS,
    faqs: [{ q: "Do I need to sign up?", a: "Not for the free trial. Sign up to save your generations and unlock unlimited." }],
  },
  ...
  // ── More language coverage — Turkish, Indonesian ──
  {
    ...
    description: "Fikrini anlat, Megsy üretime hazır bir uygulama oluştursun. Kurulum yok, DevOps yok, boilerplate yok.",
    keywords: "yapay zeka uygulama, ai web sitesi, kodsuz uygulama yap",
    eyebrow: "Yapay Zeka Kodlama",
    heading: "Ne",
    headingAccent: "inşa edeceksin?",
    subhead: "Tek cümleden canlı bir uygulamaya. Önyüz, backend, veritabanı, ödemeler — hepsi bağlı.",
    placeholder: "Megsy'den bir SaaS paneli istemek...",
    primaryCta: { label: "Ücretsiz başla", href: "/code" },
    features: [
      { title: "Tam yığın tek istemde", body: "React, Tailwind, Postgres, auth, edge functions — üretilmiş ve bağlanmış." },
      { title: "Gerçek önizleme, gerçek DB", body: "Her proje canlı URL ve özel veritabanı alır." },
      { title: "Sohbet ederek düzenle", body: "Kodunla konuş. Megsy repoyu okur ve çalışan bir diff verir." },
    ],
    models: CODE_MODELS,
  ...
  },
  {
    ...
    description: "Jelaskan idemu — Megsy membangun aplikasi siap produksi. Tanpa setup, tanpa boilerplate.",
    ...
    subhead: "Dari satu kalimat ke aplikasi yang sudah dipublikasikan. Frontend, backend, database, pembayaran — semua terhubung.",
    placeholder: "Minta Megsy membuat dashboard SaaS...",
    primaryCta: { label: "Mulai gratis", href: "/code" },
    features: [
      { title: "Full-stack dalam satu prompt", body: "React, Tailwind, Postgres, auth — semua dihasilkan dan terhubung." },
      { title: "Preview & DB asli", body: "Setiap proyek mendapat URL live dan database terisolasi." },
      { title: "Edit dengan mengobrol", body: "Bicara dengan kodemu. Megsy membaca repo dan mengirim diff yang bekerja." },
    ],
    models: CODE_MODELS,
    faqs: [{ q: "Apa saya perlu bisa coding?", a: "Tidak. Jelaskan idemu dan Megsy akan menulis serta mempublikasikannya." }],
  },
  ...
  // ── More Arabic variants per service (different content, different SEO) ──
  {
    ...
    description: "تسجيل دخول، اشتراكات Stripe، لوحات تحكم، قاعدة بيانات وبريد — كل ذلك يُولَّد ويُربط لفكرتك.",
  ...
  },
  {
    ...
    description: "إزالة الكائنات، توسيع الخلفية، تبديل الوجه، تغيير الإضاءة — كل تعديلات الصور بالذكاء الاصطناعي.",
    ...
    faqs: [{ q: "هل يعمل على الصور الحقيقية؟", a: "نعم — يدعم الصور الفعلية والمُولَّدة بالذكاء الاصطناعي." }],
  },
  {
    ...
    description: "Ideogram v3 وRecraft V3 ينتجان شعارات بمستوى مصمم، مع تصدير SVG وتنويعات ألوان غير محدودة.",
  ...
  },
  {
    ...
    description: "ارفع 10 صور سيلفي واحصل على أكثر من 100 صورة شخصية احترافية بهوية ثابتة في كل لقطة.",
  ...
  },
  {
    ...
    description: "ثامبنيلز بنسبة نقر عالية بالذكاء الاصطناعي — وجوه وتعبيرات ونصوص بارزة وألوان علامتك التجارية.",
  ...
  },
  {
    ...
    description: "ارفع صورة منتجك واحصل على لقطات استوديو غير محدودة بكل المشاهد والإضاءات. ترخيص تجاري كامل.",
  ...
  },
  {
    ...
    description: "فيديو سينمائي بالذكاء الاصطناعي مع Veo 3.1 (صوت طبيعي) وSora 2 Pro وKling 2.5 وRunway Gen-4 في مكان واحد.",
  ...
  // ── More per-model image landings (variants & angles) ──
  {
    ...
    description: "Side-by-side comparison: text rendering, photorealism, 4K, prompt fidelity. See why Nano Banana Pro is the new leader.",
    ...
    subhead: "Tested on 50+ prompts across portraits, posters, products, and scenes. Here's where Nano Banana wins, and where Midjourney still holds.",
    placeholder: "Try Nano Banana Pro on your own prompt...",
    primaryCta: { label: "Try Nano Banana Pro", href: "/images?model=nano-banana-pro" },
    features: [
      { title: "Text: Nano wins", body: "Nano Banana Pro nails typography. Midjourney still mangles letters." },
      { title: "4K: Nano wins", body: "Native 4K vs Midjourney's upscaled max." },
      { title: "Style: Midjourney still strong", body: "Midjourney's aesthetic remains distinctive on artistic prompts." },
    ],
    models: TOP_IMAGE_MODELS,
    faqs: [{ q: "Which should I use?", a: "Nano Banana Pro for product, posters, and photoreal. Midjourney for moodboards and concept art." }],
  },
  {
    ...
    description: "Full FLUX 1.1 Pro Ultra vs SDXL/SD3 comparison: prompt adherence, photorealism, speed, and licensing.",
    keywords: "flux vs stable diffusion, flux 1.1 ultra vs sdxl, best open image model",
    eyebrow: "Comparison",
    heading: "FLUX Ultra",
    headingAccent: "vs Stable Diffusion",
    subhead: "FLUX wins on prompt adherence and photorealism. SD wins on community LoRAs. Here's the full picture.",
    ...
    models: TOP_IMAGE_MODELS,
    faqs: [{ q: "Which is better for fine-tuning?", a: "SD has more LoRA tooling, FLUX is rapidly catching up." }],
  },
  {
    ...
    description: "Posters, packaging, logos, ads, billboards — Ideogram v3 nails the typography every other model botches.",
    ...
    faqs: [{ q: "Is it good for ad creatives?", a: "Yes — Ideogram v3 is the go-to for ad designers." }],
  },
  {
    ...
    description: "Runway Gen-4 — the AI video model that filmmakers use for previs, music videos, and brand spots. Available on Megsy.",
  ...
  },
  {
    ...
    description: "Hailuo 02 from MiniMax — the fastest, most expressive AI video for talking characters.",
  ...
  // ── Slides — more languages ──
  {
    ...
    description: "Tapez un sujet, recevez une présentation polie avec images, graphiques et notes du présentateur.",
  ...
  },
  {
    ...
    description: "Thema eintippen, polierte Präsentation mit Bildern, Diagrammen und Sprechernotizen erhalten.",
  ...
  // ── Deep research — more languages ──
  {
    ...
    description: "Lit 50+ sources, vérifie chaque affirmation, écrit un rapport de niveau McKinsey avec citations.",
  ...
  },
  {
    ...
    description: "Liest 50+ Quellen, prüft jede Aussage, schreibt einen McKinsey-Niveau-Bericht mit Zitaten.",
  ...
  // ── ChatGPT-alternative localized ──
  {
    ...
    description: "كل نماذج الذكاء الاصطناعي في مكان واحد — Claude Sonnet 4.5 وGemini 3 Pro وGPT-5.1 وDeepSeek. مع صور وفيديو وكود وبحث.",
    ...
    subhead: "لماذا تدفع 5 اشتراكات؟ ميجسي تجمع Claude وGPT-5.1 وGemini وصور وفيديو وكود وعروض وبحث.",
    ...
    features: [
      ...
      { title: "فاتورة واحدة", body: "اشتراك واحد يحل محل ChatGPT + Claude + Midjourney + Runway + Gamma." },
    ],
    faqs: [{ q: "كيف يقارن السعر؟", a: "ميجسي عادة أرخص بـ 2-4 مرات من مجموع الاشتراكات المنفصلة." }],
  },
  {
    ...
    description: "تجاوز Midjourney مع Nano Banana Pro غير محدود وSeedream 4 وFLUX Ultra وIdeogram v3 — كلها في تطبيق واحد.",
    ...
    models: TOP_IMAGE_MODELS,
    faqs: [{ q: "هل الجودة فعلاً مقاربة؟", a: "في معظم البرومبتات، Nano Banana Pro وSeedream 4 يتفوقان على Midjourney v7." }],
  },
  ...
  // ── Comparison / vs-Lovable angle (well-searched) ──
  {
    ...
    description: "Why builders are switching from Lovable to Megsy — better models, lower price, full media + chat + agents bundled in.",
    ...
    subhead: "Megsy ships the same Claude-powered builder as Lovable — plus chat, image, video, slides, and deep research in one subscription.",
    placeholder: "Ask Megsy to build a SaaS dashboard...",
    primaryCta: { label: "Try Megsy free", href: "/code" },
    features: [
      { title: "Same builder, more models", body: "Claude Sonnet 4.5, GPT-5.1 Codex, Gemini 3 Pro, DeepSeek V3.2 — auto-routed." },
      { title: "Bundled media + chat", body: "Unlimited image and video generation, chat, slides — included." },
      { title: "Lower price", body: "Typically 30–50% cheaper than Lovable + the side subscriptions you'd otherwise need." },
    ],
    models: CODE_MODELS,
    faqs: [{ q: "Can I import a Lovable project?", a: "Yes — bring your code via GitHub and continue in Megsy." }],
  },
  {
    slug: "v0-alternative",
    locale: "en",
    ...
    description: "v0 stops at components — Megsy ships full-stack apps with database, auth, and deployment, in one prompt.",
    keywords: "v0 alternative, vercel v0 alternative, ai full stack builder",
    eyebrow: "v0 Alternative",
    heading: "Beyond",
    headingAccent: "components",
    subhead: "v0 generates beautiful React components. Megsy generates the whole app — database, auth, payments, deploy.",
    placeholder: "Ask Megsy to build the whole SaaS, not just a button...",
    primaryCta: { label: "Try Megsy free", href: "/code" },
    features: [
      { title: "Full-stack out of the box", body: "DB, auth, billing — wired from the first prompt." },
      { title: "Live preview & deploy", body: "Every project gets a live URL and one-click custom domain." },
      { title: "Bundled chat + media", body: "All AI tools in one subscription." },
    ],
    models: CODE_MODELS,
    faqs: [{ q: "Does Megsy export components like v0?", a: "Yes — you can use Megsy in component-only mode too." }],
  },
  {
    ...
    description: "bolt.new gives you a quick demo. Megsy ships a real, deployable app with database, auth, and a real domain.",
    ...
    subhead: "Same lightning-fast prompt-to-app, but with the production essentials wired in — DB, auth, payments, deploy.",
    placeholder: "Build my real production SaaS...",
    primaryCta: { label: "Try Megsy free", href: "/code" },
    features: [
      { title: "Production-ready", body: "Database, auth, billing, edge functions — all configured." },
      { title: "Persistent projects", body: "Your code lives in Megsy and on GitHub — not a throwaway sandbox." },
  ...
  // ── Voice / TTS / transcription (high-search) ──
  {
    ...
    description: "Generate realistic voiceovers, narration, and dialogue with AI in 100+ voices and 30+ languages.",
    ...
    faqs: [{ q: "Is voice cloning ethical?", a: "Only with explicit consent — Megsy requires verification before cloning." }],
  },
  {
    ...
    description: "Upload audio or video, get accurate timestamped transcripts in minutes. Speaker diarization included.",
    ...
    subhead: "Podcasts, interviews, meetings, lectures — accurate transcripts with timestamps and speakers.",
    ...
    faqs: [{ q: "What's the accuracy?", a: "95%+ on clear audio — top tier across all major languages." }],
  },
  ...
  // ── Image upscale & restore ──
  {
    ...
    description: "Upscale any image to 4K, 8K, or 16K with AI. Restore old photos, sharpen blurry shots, denoise scans.",
    keywords: "ai image upscaler, 4k upscaler ai, ai photo enhancer, ai photo restore",
    eyebrow: "Image Upscaler",
    heading: "Upscale to",
    headingAccent: "16K",
    subhead: "Crystal-clear enlargements with no artifacts. Restore old photos, sharpen blurry scans, denoise grain.",
  ...
  // ── Chatbot / GPT builder (high-search) ──
  {
    ...
    description: "Build a custom AI chatbot trained on your docs, products, and FAQs. Deploy to your site in 10 minutes.",
    ...
    subhead: "Trained on your docs, products, and FAQs. Embedded on your site, in Slack, or on WhatsApp in minutes.",
    placeholder: "A chatbot for my SaaS docs that answers in our brand voice...",
    primaryCta: { label: "Build a chatbot", href: "/code" },
    features: [
      { title: "Trained on your data", body: "Upload PDFs, URLs, Notion, Google Docs — Megsy indexes it all." },
    ...
    models: CODE_MODELS,
    faqs: [{ q: "How is this different from a custom GPT?", a: "Megsy gives you your own embeddable, brandable bot — not locked to ChatGPT." }],
  },
];
